...
2. Линейные модели и методы оптимизации.
	- В нём предстоит написать свой класс логистической регрессии, добавить ElasticNet регуляризацию и реализовать SGD.
3. Композиции алгоритмов.
   	- В нём предстоит решить задачу машинного обучения с помощью логистической регрессии и catboost.
